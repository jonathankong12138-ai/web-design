...
4. Compare intended versus implemented behavior: flows, states, permissions, empty/loading/error cases, form validation, destructive actions, and data visibility.
5. Review code only to support findings. Cite files and lines when the issue is implementation-specific.
6. Classify issues by developer impact:
